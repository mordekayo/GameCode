...
void UGCBaseCharacterMovementComponent::Prone(bool bClientSimulation)
{
	...
	const float ClampedPronedHalfHeight = FMath::Max3(0.f, ProneCapsuleRadius, ProneCapsuleHalfHeight);
	CharacterOwner->GetCapsuleComponent()->SetCapsuleSize(ProneCapsuleRadius, ClampedPronedHalfHeight);
